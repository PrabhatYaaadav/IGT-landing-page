jQuery(
  (function ($) {
    ...
    function makeTimer() {
      const endTime = Date.parse("september 20, 2026 17:00:00 PDT") / 1000;
      ...
      $("#days").html(days + "<span> Days</span>");
      $("#hours").html(pad(hours) + "<span> Hours</span>");
      $("#minutes").html(pad(minutes) + "<span> Minutes</span>");
      $("#seconds").html(pad(seconds) + "<span> Seconds</span>");
    }
